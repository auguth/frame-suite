...
```sh
./target/release/frame-suite-node -h
```
...
```sh
RUST_BACKTRACE=1 ./target/release/frame-suite-node -ldebug --dev
```
...
$ ./target/release/frame-suite-node --dev --base-path ./my-chain-state/
